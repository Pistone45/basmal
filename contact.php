...
if(isset($_POST['submit'])){
	$recipient ="malawibasketball@gmail.com";
	$name = $_POST['name'];
	$email = $_POST['email'];
...
<head>
    ...
    <title>Contact Basketball Association of Malawi</title>
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
		  ...
		  <?php
				if(isset($_SESSION["message-sent"]) && $_SESSION["message-sent"]==true)
				{
					...
					echo "<strong>Success! </strong>"; echo "Message sent - We will get back to you";
        ...
        <div class="col-lg-4">
          ...
          <div class="media contact-info">
            ...
            <div class="media-body">
              <h3>info@malawibasketball.com</h3>
