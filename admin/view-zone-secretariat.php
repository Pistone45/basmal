...
if(!isset($_SESSION['user'])){
    ...
    $secretariats = $getZonesSecretariat->getZonesSecretariat($id = $_POST['zones_id']);
...
<head>
  ...
  <title>View Zones Secretariat | Basmal</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        View Zones Secretariat
       
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="view-secretariat.php">View Zones Secretariat</a></li>
       ...
       <?php
            if(isset($secretariats) && count($secretariats)>0){
              ...
              <tr>
                ...
                <td><a href="edit-zone-secretariat.php?id=<?php echo $secretariat['id']; ?>"><i class="fa fa-pencil"></i> Edit Secretariat</a></td>
              ...
              echo "No Zones Secretariats available";
            } ?>
