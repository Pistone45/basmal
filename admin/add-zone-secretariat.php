...
if(isset($_POST['submit'])){
    ...
    $zones_id = $_POST['zones_id'];

	 $newSecretariat = new Secretariat();
	 $newSecretariat->addZoneSecretariat($fullname,$position, $description, $zones_id, $secretariat_image);
...
<head>
  ...
  <title>Add Zone Secretariat | Basmal</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Add Zone Secretariat
       
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="#">Add Zone Secretariat</a></li>
	...
	<!-- form start -->
            <form role="form" action="add-zone-secretariat.php" method="POST" enctype="multipart/form-data">
			<?php
                            if(isset($_SESSION["zone-secretariat-added"]) && $_SESSION["zone-secretariat-added"]==true)
                            {
                                echo "<div class='alert alert-success'>";
                                echo "<button type='button' class='close' data-dismiss='alert'>*</button>";
                                echo "<strong>Success! </strong>"; echo "You have successfully added a Zone Secretariat";
                                unset($_SESSION["zone-secretariat-added"]);
                                echo "</div>";
								 header('Refresh: 5; URL= view-zone-secretariat.php');
                            }
							?>
          ...
          <!-- general form elements -->
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select name="zones_id" class="form-control" id="exampleFormControlSelect1">
