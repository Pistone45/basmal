...
<head>
  ...
  <title>Add Banner | Basketball Association of Malawi</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="add-product.php">Add Banner</a></li>
	...
	<!-- form start -->
			...
			<?php
                            if(isset($_SESSION["banner-added"]) && $_SESSION["banner-added"]==true)
                            {
                                ...
                                echo "<strong>Success! </strong>"; echo "You have successfully added a new banner";
                                unset($_SESSION["banner-added"]);
                                echo "</div>";
								 header('Refresh: 5; URL= add-banner.php');
                            }
							?>
