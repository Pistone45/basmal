...
INSERT INTO `roles` VALUES (1,'Admin'),(2,'Editor'),(3,'reporter');
...
CREATE TABLE `users` (
  ...
  `media_house` varchar(255) DEFAULT NULL,
...
INSERT INTO `users` VALUES ('blena.c@gmail.com','blena.c@gmail.com','$2y$10$Gj4zStb9dyoV2u.ZNnmndOCuFbwehMj9NEwceFfXCHEiWIRQNj3MS','0999463686','Blena','N','Chisenga',1,NULL,'1'),('malawibasketball@gmail.com','malawibasketball@gmail.com','$2y$10$VOIpqsR7gb7doSspRucx8.c99BFQW6ACZ2jRk3jknmmFc.SG5Ffhq\n','0996555501','Basmal',NULL,'MW',10,NULL,'1'),('admin@admin.com','admin@admin.com','$2y$10$H/gqvUtrii6BR14NCbmS6.dFd.AQP3niPLMQrTHpwea6fXoDVsvk6','0882550227','Pistone','J','Sanjama',1,NULL,'1'),('pistonsanjama45@gmail.com','pistonsanjama45@gmail.com','$2y$10$5p/k9juErMKpmgQ.rJmi5OSoFM9iqLgSh5MYvGm11cINU1yiCDH/e\n','+265882550227','Pistone',NULL,'Sanjama',3,'zodiak','1');
...
INSERT INTO `videos` VALUES (2,'https://www.youtube.com/embed/5thLACHhvy0','Description Description Description Description DescriptionDescription Description \r\n Description Description'),(3,'https://www.youtube.com/embed/wpqJlxd3o1I','Description Description Description Description Description Description Description Description Description Description '),(4,'https://www.youtube.com/embed/R5ixMxQfxJ0','description description description description description description description description description description '),(5,'https://www.youtube.com/embed/dulPWP7vDj8','description description description description description description description description description description ');
...
--
-- Table structure for table `zones_secretariat`
--

DROP TABLE IF EXISTS `zones_secretariat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zones_secretariat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `zones_secretariat`
--

LOCK TABLES `zones_secretariat` WRITE;
/*!40000 ALTER TABLE `zones_secretariat` DISABLE KEYS */;
INSERT INTO `zones_secretariat` VALUES (1,'blena Chisenga','THE DIRECTOR OF MARKETING & RESOURCE MOBILIZATION','description description description description description description description description description description description description description description description description description ',NULL,1,3),(2,'John Doe','THE PRESIDENT OF BASMAL','description description description description description description description description description description description description description description description description description ',NULL,1,1),(3,'Jane Doe','THE VICE PRESIDENT OF BASMAL','description description description description description description description description description description description description description description description description description ',NULL,1,2),(4,'Pistone Sanjama','TRESURER','description description description description description description description description description description description description description description description description description ',NULL,2,3),(5,'Lisungu Banda','THE PRESIDENT OF BASMAL','description description description description description description description description description description description description description description description description description ',NULL,2,1),(6,'Philip Onions','THE VICE PRESIDENT','description description description description description description description description description description description description description description description description description ',NULL,2,2),(7,'Shepherd Lungu','THE PRESIDENT OF BASMAL','description description description description description description description description description description description description description description description description description ',NULL,3,1),(8,'Hope Chisamanga','THE VICE GENERAL SECRETARY','description description description description description description description description description description description description description description description description description ',NULL,3,3),(9,'Hope Jere','THE VICE PRESIDENT','description description description description description description description description description description description description description description description description description ',NULL,3,2);
/*!40000 ALTER TABLE `zones_secretariat` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-05-15 15:57:25
